...
for e in epochs:
	...
	adressTrain = adressSan + "train_A=" + P.Alpha +"-L="+ P.Lambda +"-O=vector-KP="+ P.KPred +"-KD="+ P.KDisc +"-NN=2-Rec=On-E="+ str(e) +".csv"
	adressTest = adressSan + "test_A=" + P.Alpha +"-L="+ P.Lambda +"-O=vector-KP="+ P.KPred +"-KD="+ P.KDisc +"-NN=2-Rec=On-E="+ str(e) +".csv"
